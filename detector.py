...
REPO_ROOT = _APP_DIR  # this repo's root (flattened out of the streamlit_app/ subfolder)
...
# metrics far below yolo26m_merged_150ev2 (precision 61,8% vs 91,5%, recall 47,4% vs 84,6%,
# mAP50 47,5% vs 89,0%, mAP50-95 20,1% vs 59,1%). Read this as an
...
# 20,1%) -- still far below yolo26m_merged_150ev2 (this app's previous default). Read this
# as the same early-stage picture as v1, now on the bigger preprocessed dataset. Wired in as
# the Demo page's default below despite the weaker aggregate numbers -- see DEFAULT_WEIGHTS.
...
# Redesigned Aug 2026 to match the HI-VIS mockup: person stays a neutral
# near-white tag (it's not a compliance finding), "present" items sit in a
# cool family (blue/green/teal/cyan/purple), "missing" items in a warm one
# (red/orange/coral/rose/pink) — so a box's fill color alone tells you
# present-vs-missing before you even read the label baked onto it.
CLASS_META = {
